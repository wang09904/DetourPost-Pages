...
| Informações de conexão | Status de relacionamento, códigos de convite e segredos de reivindicação | Necessário para troca de cartas |
| Conteúdo da carta | Texto da carta, escolha de papelaria, fotos anexadas, correio, hora de chegada | Criado somente quando você escolhe enviar |
